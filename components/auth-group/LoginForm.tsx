...
const LoginForm = ({ callbackUrl }: LoginFormProps) => {
  ...
  >
    ...
    <div className="grid w-full gap-2">
      <Label htmlFor="email" className="font-small-text font-semibold tracking-wide">
        Email Address *
      </Label>
      <Input
        disabled={submitting}
      ...
      />
      {errors.email && (
        <div id="email-error" className="mt-1 flex items-center gap-2 text-red-500">
          <ErrorIcon />
    ...
    {/* Password */}
    <div className="grid w-full gap-2">
      <Label htmlFor="password" className="font-small-text font-semibold tracking-wide">
        Password *
      </Label>
      ...
      <div className="relative">
        ...
        >
          ...
          >
            {showPassword ? (
              <PiEye className="text-white h-5 w-5" />
            ) : (
              <PiEyeClosed className="text-white h-5 w-5" />
            )}
          </button>
        </div>
      </div>
      {errors.password && (
        <div id="password-error" className="mt-1 flex items-center gap-2 text-red-500">
          <ErrorIcon />
