...
const PlayButton = ({ children, ...props }: PlayButtonProps) => {
  return (
    <Button
      ...
      className="mt-6 flex items-center justify-center rounded-sm bg-white px-8 py-3 text-lg font-semibold tracking-wide text-black shadow-md transition duration-300 ease-in-out hover:bg-gray-200 lg:text-xl"
      type="button"
    >
