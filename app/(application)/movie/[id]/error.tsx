...
export default function Error({
  ...
  return (
    <div className="mt-[90px] flex h-[80dvh] flex-col items-center justify-center px-4 text-white lg:mt-[100px]">
      <Image
      ...
      <p className="mb-8 max-w-[34rem] text-center text-base text-[#e50914] md:text-lg lg:max-w-[38rem]">
        {error.message}
      </p>
